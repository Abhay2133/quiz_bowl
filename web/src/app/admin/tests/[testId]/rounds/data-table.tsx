...
export function DataTable<TData, TValue>({
  ...
  data,
  openCreateDialog,
}: DataTableProps<TData, TValue> & {openCreateDialog:any}) {
  ...
  const filterList:string[] = ["id", "name", "duration", "easyQ", "mediumQ", "hardQ", ]
  ...
  return (
    <div className="flex flex-col min-w-full px-3 md:min-w-[80%]">
      ...
      {/* <Button className="mt-3">Create New Test</Button> */}
    </div>
  )
}
